...
//                 let pt = m[0].main;
//                 for (let p of pt) {
//                     for (let d of nr.permission) {
//                         if(d.componentroot ){

//                         }
//                         if (p.state == d.componentpath)
//                             tempData.push(p);
//                     }
//                 }
//             }
...
//         m[0]["main"] = tempData;
//         this.allmenuitems = m;
//         for(let a of this.allmenuitems){
//             console.log(a,"permissions child");
//         }
//         // this.allmenuitems = r.rolepermissions[0].permissions;
